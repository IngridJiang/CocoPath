        ...
        try {
            ...
            if (existingTag != null) {
                ...
                if (DEBUG) {
                    ...
                    System.out.println("  Domain: " + min + " <= " + qualifiedName + " < " + (max + 1));
                    System.out.println("  Switch: " + qualifiedName + " == " + concreteValue);
                }
            ...
            if (DEBUG) {
                ...
                System.out.println("[GaletteSymbolicator:getOrMakeSymbolicInt] Recorded switch constraint: "
                        + qualifiedName + " == " + concreteValue);
            }
