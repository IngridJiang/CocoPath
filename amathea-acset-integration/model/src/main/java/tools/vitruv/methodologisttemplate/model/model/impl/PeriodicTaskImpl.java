 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.methodologisttemplate.model.model.impl.PeriodicTaskImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link tools.vitruv.methodologisttemplate.model.model.impl.PeriodicTaskImpl#getDelay <em>Delay</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PeriodicTaskImpl extends TaskImpl implements PeriodicTask {
    ...
    public void setPeriod(double newPeriod) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                    this, Notification.SET, ModelPackage.PERIODIC_TASK__PERIOD, oldPeriod, period));
    }
    ...
    public void setDelay(double newDelay) {
        ...
        delay = newDelay;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PERIODIC_TASK__DELAY, oldDelay, delay));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.PERIODIC_TASK__PERIOD:
                return getPeriod();
            case ModelPackage.PERIODIC_TASK__DELAY:
                return getDelay();
        }
