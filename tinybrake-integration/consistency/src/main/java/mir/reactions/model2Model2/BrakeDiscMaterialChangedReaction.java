...
public class BrakeDiscMaterialChangedReaction extends AbstractReaction {
    private ReplaceSingleValuedEAttribute<BrakeDisc, String> replaceChange;

    public BrakeDiscMaterialChangedReaction(
    ...
    private static class Call extends AbstractRoutine.Update {
        ...
        public void updateModels(
            ...
            _routinesFacade.updateBrakingTorque(affectedEObject);
        }
    }
    ...
    public boolean isCurrentChangeMatchingTrigger(final EChange change) {
        ...
        ReplaceSingleValuedEAttribute<tools.vitruv.methodologisttemplate.model.model.BrakeDisc, java.lang.String>
                _localTypedChange = (ReplaceSingleValuedEAttribute<
                                tools.vitruv.methodologisttemplate.model.model.BrakeDisc, java.lang.String>)
                        change;
        if (!(_localTypedChange.getAffectedElement()
                instanceof tools.vitruv.methodologisttemplate.model.model.BrakeDisc)) {
            return false;
        }
        if (!_localTypedChange.getAffectedFeature().getName().equals("material")) {
            return false;
        }
        if (_localTypedChange.isFromNonDefaultValue()
                && !(_localTypedChange.getOldValue() instanceof java.lang.String)) {
            return false;
        }
    ...
    public void executeReaction(
        ...
        new mir.reactions.model2Model2.BrakeDiscMaterialChangedReaction.Call(executionState)
