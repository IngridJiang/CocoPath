...
public class CreateOffRoadAxleUnitRoutine extends AbstractRoutine {
    private CreateOffRoadAxleUnitRoutine.InputValues inputValues;

    private CreateOffRoadAxleUnitRoutine.Match.RetrievedValues retrievedValues;

    private CreateOffRoadAxleUnitRoutine.Create.CreatedValues createdValues;
    ...
    private static class Match extends AbstractRoutine.Match {
        ...
        public CreateOffRoadAxleUnitRoutine.Match.RetrievedValues match(
            ...
            return new mir.routines.model2Model2.CreateOffRoadAxleUnitRoutine.Match.RetrievedValues(controlSystem);
        }
    }
    ...
    private static class Create extends AbstractRoutine.Create {
        ...
        public CreateOffRoadAxleUnitRoutine.Create.CreatedValues createElements() {
            ...
            return new CreateOffRoadAxleUnitRoutine.Create.CreatedValues(axleUnit);
        }
    }
    ...
    public CreateOffRoadAxleUnitRoutine(
        ...
        this.inputValues = new CreateOffRoadAxleUnitRoutine.InputValues(system, sourceDisc);
    }

    protected boolean executeRoutine() throws IOException {
        if (getLogger().isTraceEnabled()) {
            getLogger().trace("Called routine CreateOffRoadAxleUnitRoutine with input:");
            getLogger().trace("   inputValues.system: " + inputValues.system);
            getLogger().trace("   inputValues.sourceDisc: " + inputValues.sourceDisc);
        }
        retrievedValues = new mir.routines.model2Model2.CreateOffRoadAxleUnitRoutine.Match(getExecutionState())
                .match(inputValues.system, inputValues.sourceDisc);
        if (retrievedValues == null) {
            return false;
        }
        createdValues =
                new mir.routines.model2Model2.CreateOffRoadAxleUnitRoutine.Create(getExecutionState()).createElements();
        new mir.routines.model2Model2.CreateOffRoadAxleUnitRoutine.Update(getExecutionState())
                .updateModels(
                        inputValues.system,
