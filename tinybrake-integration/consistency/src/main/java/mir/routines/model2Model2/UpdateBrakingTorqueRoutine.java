...
public class UpdateBrakingTorqueRoutine extends AbstractRoutine {
    private UpdateBrakingTorqueRoutine.InputValues inputValues;

    private UpdateBrakingTorqueRoutine.Match.RetrievedValues retrievedValues;
    ...
    private static class Match extends AbstractRoutine.Match {
        ...
        public UpdateBrakingTorqueRoutine.Match.RetrievedValues match(final BrakeDisc sourceDisc) throws IOException {
            ...
            return new mir.routines.model2Model2.UpdateBrakingTorqueRoutine.Match.RetrievedValues(axleUnit);
        }
    }
    ...
    public UpdateBrakingTorqueRoutine(
        ...
        this.inputValues = new UpdateBrakingTorqueRoutine.InputValues(sourceDisc);
    }

    protected boolean executeRoutine() throws IOException {
        if (getLogger().isTraceEnabled()) {
            getLogger().trace("Called routine UpdateBrakingTorqueRoutine with input:");
            getLogger().trace("   inputValues.sourceDisc: " + inputValues.sourceDisc);
        }
        retrievedValues = new mir.routines.model2Model2.UpdateBrakingTorqueRoutine.Match(getExecutionState())
                .match(inputValues.sourceDisc);
        if (retrievedValues == null) {
            return false;
        }
        // This execution step is empty
        new mir.routines.model2Model2.UpdateBrakingTorqueRoutine.Update(getExecutionState())
