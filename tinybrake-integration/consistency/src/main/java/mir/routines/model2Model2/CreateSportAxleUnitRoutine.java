...
public class CreateSportAxleUnitRoutine extends AbstractRoutine {
    private CreateSportAxleUnitRoutine.InputValues inputValues;

    private CreateSportAxleUnitRoutine.Match.RetrievedValues retrievedValues;

    private CreateSportAxleUnitRoutine.Create.CreatedValues createdValues;
    ...
    private static class Match extends AbstractRoutine.Match {
        ...
        public CreateSportAxleUnitRoutine.Match.RetrievedValues match(
            ...
            return new mir.routines.model2Model2.CreateSportAxleUnitRoutine.Match.RetrievedValues(controlSystem);
        }
    }
    ...
    private static class Create extends AbstractRoutine.Create {
        ...
        public CreateSportAxleUnitRoutine.Create.CreatedValues createElements() {
            ...
            return new CreateSportAxleUnitRoutine.Create.CreatedValues(axleUnit);
        }
    }
    ...
    public CreateSportAxleUnitRoutine(
        ...
        this.inputValues = new CreateSportAxleUnitRoutine.InputValues(system, sourceDisc);
    }

    protected boolean executeRoutine() throws IOException {
        if (getLogger().isTraceEnabled()) {
            getLogger().trace("Called routine CreateSportAxleUnitRoutine with input:");
            getLogger().trace("   inputValues.system: " + inputValues.system);
            getLogger().trace("   inputValues.sourceDisc: " + inputValues.sourceDisc);
        }
        retrievedValues = new mir.routines.model2Model2.CreateSportAxleUnitRoutine.Match(getExecutionState())
                .match(inputValues.system, inputValues.sourceDisc);
        if (retrievedValues == null) {
            return false;
        }
        createdValues =
                new mir.routines.model2Model2.CreateSportAxleUnitRoutine.Create(getExecutionState()).createElements();
        new mir.routines.model2Model2.CreateSportAxleUnitRoutine.Update(getExecutionState())
                .updateModels(
                        inputValues.system,
